...
public class IndexServlet extends HttpServlet {
     ...
     */
    private static final String VALIDATION_URL = "http://sso.nekolr.com/validate?serverKey=appA&token=";
    ...
    private void doHandle(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (!StringUtils.isEmpty(token)) {
            ...
            if (!StringUtils.isEmpty(result)) {
                ...
                String sex = (String) com.nekolr.util.StringUtils.getFromJsonString(result, "sex");
                // 设置会话
